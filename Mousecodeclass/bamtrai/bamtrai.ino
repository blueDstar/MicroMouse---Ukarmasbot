...
// Ngưỡng cảm biến
const int SENSOR_FRONT_LEFT_THRESHOLD = 200;
const int SENSOR_FRONT_RIGHT_THRESHOLD = 200;
const int SENSOR_LEFT_THRESHOLD = 230;
const int SENSOR_RIGHT_THRESHOLD = 230;

// Thời gian quay 90 độ (ms)
const unsigned long TURN_TIME_90_DEGREES = 130;
